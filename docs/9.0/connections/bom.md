...
function Csv\bom_match(string $str): string
~~~

The `Csv\bom_match` function expects a string and returns the BOM sequence found at its start or an empty string otherwise.
